...
<table class="table my-3">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $this->element('upload_image', array('imageIdPreview' => 'idPreview')); ?></td>
            <td></td>
        </tr>
        <tr>
...
<script>
    ...
    $('#submitPrestador').on('click', function(e){
        ...
        $.ajax({
            url: '<?php echo $this->Html->url(array('controller' => 'prestadores', 'action' => 'addPrestador')); ?>',
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
